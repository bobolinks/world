...
import type { DelayFill } from '../../types/types';
...
import type { NodeEventMap } from '../../types/types';
import type { NodePinsPair } from '../../types/types';
import * as Nodes from 'three/examples/jsm/nodes/Nodes';
import { Object3D } from 'three';
import { Object3DEventMap } from 'three';
import type { Object3DEventMap as Object3DEventMap_2 } from '../../types/types';
import type { ObjectsMap } from '../../types/types';
import type { ObjectsTransfer } from './types/types';
import { PerspectiveCamera } from 'three';
import type { PinValueType } from '../../types/types';
...
export declare class AudioListener2 extends AudioListener_2 {
...
declare interface PhysicalObject extends THREE_2.Mesh {
    world?: PhysicalWorld;
    mass: number;
}
...
declare class PhysicalWorld {
    ...
    setMeshPosition(mesh: PhysicalObject, position: THREE_2.Vector3, index?: number): void;
...
export declare class U3JsRuntime extends THREE_2.EventDispatcher {
    readonly context: HTMLCanvasElement;
    readonly renderer: THREE_2.WebGLRenderer;
    readonly clock: THREE_2.Clock;
    readonly size: {
        width: number;
        height: number;
    };
    ...
    protected currentCamera: THREE_2.Camera;
    protected defaultCamera: THREE_2.PerspectiveCamera;
    ...
    createObjectFromSpawn(name: string): THREE_2.Object3D<THREE_2.Object3DEventMap> | undefined;
    setCamera(camera: THREE_2.Camera): void;
...
export declare interface WorldSettings {
    aspect: number | 'auto';
    toneMapping?: THREE_2.ToneMapping;
    toneMappingExposure?: number;
    shadowMap?: {
        enabled: boolean;
        type: THREE_2.ShadowMapType;
    };
}
